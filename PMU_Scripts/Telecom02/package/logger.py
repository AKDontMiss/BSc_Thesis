...
def add_color_to_log(function):
	"""
	It changes colour of the log messages based on the log level specified in configurations.py file. It assigns a different colour to each log level message (debug, info, error and warning).
	"""
